...
{
  switch (err){
  case pmc_uconv_err_success:
   return "PMCErrorSuccess"; 
  case pmc_uconv_err_malformed:
   return "PMCErrorMalformed"; 
  case pmc_uconv_err_range:
   return "PMCErrorRange"; 
  case pmc_uconv_err_incomplete:
   return "PMCErrorIncomplete"; 
  case pmc_uconv_err_bufferfull:
   return "PMCErrorBufferFull"; 
  }
  return "PMCErrorUnknown";
}
