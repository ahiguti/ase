...
-- initialize COM
local WShell = ASE.COM.CreateObject("WScript.Shell");

local Forms = ASE.CLR.Load("System.Windows.Forms", "System.Windows.Forms");
local Drawing = ASE.CLR.Load("System.Drawing", "System.Drawing");
local Uri = ASE.CLR.Load("System", "System.Uri");
