...
var clipboard_atom =
  Perl.Methods['Gtk2::Gdk::Atom'].intern('CLIPBOARD');
...
var clipboard =
  gtkclipboard.get_for_display(display, clipboard_atom);
...
mainwin.signal_connect('delete_event',
  function() { gtk.main_quit(); });
var callbacks = {
  on_quit_activate : function() {
    gtk.main_quit(); },
